...
from routes import db_CRUD, health,schemas,generics,relationships,auth_routes  # Separate routers
...
app.mount("/api/static", StaticFiles(directory="static"), name="api-static-uploads")
